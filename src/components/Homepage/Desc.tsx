          ...
          <div className="text-primary md:order-2 order-1">
            <div>
              ...
              <p className="md:max-w-[430px]">
                ...
                whole company is out there, organized, and accessible when (and
                if) you want it.
              </p>
              <button className="underline text-[#50519E]">Learn More</button>
            </div>
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-5">
          <div className="text-primary">
            <div>
              ...
              <p className="md:max-w-[430px]">
                If all the people are in Slack, and all your apps, resources and
                tools are part of the conversation, you don’t have to put in
                extra work to connect them. They’re just there, and youre all on
                the same page, ready to go.
              </p>
              <button className="underline text-[#50519E]">Learn More</button>
            </div>
            <div className="mt-9 pt-8 border border-t-[#99999E] border-r-0 border-b-0 border-l-0 md:max-w-[380px]">
              <div className="flex items-start justify-between gap-3">
                ...
                <div>
                  <p className="italic">
                    “Slack is not only great at connecting people, it’s great at
                    connect- ing the tools and systems we already have.”
                  </p>
                  <p className="pt-3 font-bold">
                    Nick Coronges, R/GA{" "}
                    <span className="text-[#50519E] font-normal">
